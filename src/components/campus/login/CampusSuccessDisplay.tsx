...
interface CampusSuccessDisplayProps {
  campusName: string;
}

const CampusSuccessDisplay = ({ campusName }: CampusSuccessDisplayProps) => {
  return (
    <motion.div
      ...
      <div className="flex items-center justify-center gap-2 text-xl font-bold text-green-600">
        ...
        <span>{campusName} 캠퍼스 인증 성공!</span>
      </div>
...
export default CampusSuccessDisplay;
