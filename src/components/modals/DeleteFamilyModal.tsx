...
const DeleteFamilyModal: React.FC<DeleteFamilyModalProps> = ({ isOpen, onClose, onConfirm, title, memberName }) => {
        ...
        <div className="p-6 xs:p-4">
          ...
          <div className="mb-4 flex items-center justify-between xs:mb-3">
            <div className="flex items-center gap-3 xs:gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 xs:text-xs">삭제한 가족원은 복구할 수 없어요.</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="mb-6 space-y-3 rounded-xl bg-gray-50 p-4 xs:mb-4 xs:p-3">
            <div className="flex items-center gap-2">
              <p className="text-base font-semibold text-gray-900 xs:text-sm">&quot;{memberName}&quot;</p>
            </div>
          </div>

          <div className="mb-6 rounded-xl bg-red-50 p-4 xs:mb-4 xs:p-3">
            <p className="text-sm text-red-600 xs:text-xs">
              정말로 이 가족원을 삭제할까요? 이 작업은 되돌릴 수 없어요.
            </p>
          </div>
